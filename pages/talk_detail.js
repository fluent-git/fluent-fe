...
class TalkDetail extends Component {
  constructor(props) {
    ...
    this.state = { clarity: '', pacing: '', pronunciation: '', note: '', nbspPadding: 31, topic: '', duration: 0, time: '', available: '', loggedIn: loggedIn, username: username, userId: userId, token: token, data: [] }
  }
